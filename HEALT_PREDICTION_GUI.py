...
# Function to predict health condition based on user input and display in a window
def predict_health_condition_display():
    # Input from the user using GUI
    window = tk.Tk()
    window.title("Know Your Health")
    window.geometry("410x460")  # Set initial dimensions
    ...
    # Labels and Entry Widgets for health parameters
    ...
    # Function to get user input and display the prediction
    def get_user_input():
        # Get user input
        user_info = {
            'Name': name_entry.get(),
        ...
        # Display the predicted health condition in the GUI window
...
# Call the function to predict health condition based on user input using the GUI
